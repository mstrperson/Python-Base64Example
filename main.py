...
def b64ToBytes(b64string):
    ...
    for i in range(0, len(b64string), 4):
        ...
        chunk = int(((base64_charset.index(b64string[i]) * 64 + base64_charset.index(b64string[i+1])) * 64 + (base64_charset.index(b64string[i+2])%64)) * 64 + (base64_charset.index(b64string[i+3]%64)))
        print chunk
